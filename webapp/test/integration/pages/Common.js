sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/test/app/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.test.app.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/test/app/localService/mockserver"], function (mockserver) {
