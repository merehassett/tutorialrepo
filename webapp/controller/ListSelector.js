sap.ui.define([
		...
		return BaseObject.extend("com.test.app.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.test.app.model.ListSelector
			 */
			 ...
			 * @return {com.test.app.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
